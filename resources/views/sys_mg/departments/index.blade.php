...
<div class="container" style="width: 100%">
    <h4 class="grey-text text-darken-2 center">Room Management</h4>
    
    {{-- Include the searh component with with title and route --}}
    @component('sys_mg.inc.search',['title' => 'Room' , 'route' => 'departments.search'])
    @endcomponent
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                <div class="row">
                    <h5 class="pl-15 grey-text text-darken-2">Room List</h5>
                     <a href="{{route('departments.create')}}">
                <button class="btn waves-effect waves-light right">Create New</button></a>
