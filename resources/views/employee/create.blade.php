    ...
    <div class="container" style="width: 100%">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                <div>
                <h4 class="center grey-text text-darken-2 card-title">Patient Infor</h4>
                </div>
                <hr>
                    ...
                    <form action="{{route('employees.store')}}" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6 l6 xl4">
                                ...
                                <select name="salary">
                                    <option value="" disabled {{ old('salary') ? '' : 'selected' }}>Choose a Price</option>
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="division">
                                    <option value="" disabled {{ old('division') ? '' : 'selected' }}>Choose a Symptoms</option>
