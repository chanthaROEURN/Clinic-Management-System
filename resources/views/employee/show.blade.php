        ...
        <div class="card-panel grey-text text-darken-2 mt-20">
            ...
            <div class="row">
                ...
                <div class="collection">
                    ...
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Room :</span><span class="col m8 l8 xl9">{{$employee->empDepartment->dept_name}}</span></p>
                    </div>
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Symptom :</span><span class="col m8 l8 xl9">{{$employee->empDivision->division_name}}</span></p>
                    </div>
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Email :</span><span class="col m8 l8 xl9">{{$employee->email}}</span></p>
                    </div>
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Price :</span><span class="col m8 l8 xl9">${{$employee->empSalary->s_amount}}/-</span></p>
                    </div>
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Start Date :</span><span class="col m8 l8 xl9">{{$employee->join_date}}</span></p>
                    </div>
                    <div class="row">
                        <p class="pl-15"><span class="bold col s5 m4 l4 xl3">Leave Date :</span><span class="col m8 l8 xl9">{{$employee->birth_date}}</span></p>
                    </div>
                </div>
