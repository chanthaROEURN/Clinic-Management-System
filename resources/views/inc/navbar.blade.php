<header>
    <nav class="" style="background-color: grey;width: 109%; margin-left: -90px">
        <!-- <nav class="gradient-bg"> -->
        <div class="container">
            <div class="nav-wrapper">
                <a href="{{route('dashboard')}}" class="brand-logo hide-on-small-only">Welcome To Clinic System</a>
                ...
                <ul class="right"  style="margin-right: -20%">
                    <li>
